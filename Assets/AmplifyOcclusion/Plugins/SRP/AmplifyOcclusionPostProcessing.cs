...
public sealed class AmplifyOcclusionRenderer : PostProcessEffectRenderer<AmplifyOcclusionPostProcessing>
{
	...
	void UpdateGlobalShaderConstants( CommandBuffer cb, Camera aCamera )
	{
		...
		if( m_lightweightRenderPipeline != null )
		{
	...
	private UnityEngine.Rendering.Universal.UniversalRenderPipeline m_lightweightRenderPipeline = null;
	...
	public override void Init()
	{
		...
		m_lightweightRenderPipeline = UnityEngine.Rendering.RenderPipelineManager.currentPipeline as UnityEngine.Rendering.Universal.UniversalRenderPipeline;
		if( m_lightweightRenderPipeline != null )
		{
			UsingMotionVectors = false;
		}
